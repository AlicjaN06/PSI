...
#4. Tworzenie podstawowych statystyk wszystkich kolumn
summary(kraje_1)
summary(kraje_2)

#5. Statystyki pojedynczej kolumny (zmiennej)
...
#6. Porządkowanie nazw kolumn (zmiennych)

#6.1. Usuwanie zbędnej kolumny
kraje_1$X = NULL
kraje_2$X = NULL

#6.2. Zmiana nazw kolumn z angielskich na polskie
